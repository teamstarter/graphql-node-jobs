        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, models_1["default"])(config, options ? options.dbhash : null)];
                case 1:
                    models = _a.sent();
...
commander_1["default"]
    ...
    .action(function (nbDays, nbJobsPerDay) {
    return __awaiter(this, void 0, void 0, function () {
        var configTest, models;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    configTest = require('./../tests/sqliteTestConfig.js');
                    return [4 /*yield*/, (0, models_1["default"])(configTest, '')];
                case 1:
                    models = _a.sent();
