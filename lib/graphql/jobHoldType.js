...
function jobHoldType(graphqlTypes, models) {
    var _this = this;
    return {
            ...
            toggleHoldJobType: {
                ...
                resolve: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, models.jobHoldType.findOne({
                                    where: { type: args.type }
                                })];
                            case 1:
                                jobHoldType = _a.sent();
                                if (!!jobHoldType) return [3 /*break*/, 3];
                                return [4 /*yield*/, models.jobHoldType.create({
                                        type: args.type
                                    })];
                            case 2: return [2 /*return*/, _a.sent()];
                            case 3: return [4 /*yield*/, models.jobHoldType.destroy({
                                    where: { type: args.type }
                                })];
                            case 4:
                                _a.sent();
