...
function putNextStepJobsInTheQueued(nextStep, models) {
    return __awaiter(this, void 0, void 0, function () {
        var job, jobs;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!nextStep.jobId) return [3 /*break*/, 2];
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!nextStep.batchId) return [3 /*break*/, 4];
...
function updatePipelineStatus(pipelineId, models) {
    return __awaiter(this, void 0, void 0, function () {
        var steps, status, _i, steps_1, step, job, batch, pipeline;
        return __generator(this, function (_a) {
            switch (_a.label) {
            ...
            after: function (job, oldJob) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if ((job.status === 'successful' || job.status === 'failed') &&
                                ...
                                debounceBatch(function () { return __awaiter(_this, void 0, void 0, function () {
                                    var batch, jobs, jobsStatus, allJobsAreSuccessful, step, nextStep;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 2:
                                                jobs = _a.sent();
                                                jobsStatus = jobs.map(function (job) { return job.status; });
                                                allJobsAreSuccessful = jobsStatus.every(function (status) { return status === 'successful'; });
                                            ...
                                            case 5:
                                                ...
                                                return [4 /*yield*/, putNextStepJobsInTheQueued(nextStep, models)];
                                            case 6:
                                                _a.sent();
                                                return [3 /*break*/, 9];
                                            case 7: return [4 /*yield*/, updatePipelineStatus(batch.pipelineId, models)];
                                            case 8:
                                                _a.sent();
                                                _a.label = 9;
                                            case 9: return [3 /*break*/, 12];
                                            case 10:
                                                if (!jobsStatus.includes('failed')) return [3 /*break*/, 12];
                                                return [4 /*yield*/, batch.update({
                                                        status: 'failed'
                                                    })];
                                            case 11:
                            ...
                            if (!((job.status === 'successful' || job.status === 'failed') &&
                                job.pipelineId)) return [3 /*break*/, 7];
                            return [4 /*yield*/, models.pipelineStep.findOne({
                                    where: { jobId: job.id }
                                })
                        ...
                        return [4 /*yield*/, updatePipelineStatus(step.pipelineId, models)];
                        case 6:
                            // When the last step of a pipeline is finished then we update its status
                            _a.sent();
                            _a.label = 7;
        ...
        create: {
            ...
            after: function (job, source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!job.pipelineId) return [3 /*break*/, 3];
