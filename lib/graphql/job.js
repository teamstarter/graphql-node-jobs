                        ...
                        case 1:
                            ...
                            if (job.status === 'cancel-requested' &&
                                ...
                                if (job.isUpdateAlreadyCalledWhileCancelRequested) {
                                    ...
                                    throw new CancelRequestedError('The job was requested to be cancelled at the previous call. Please check for the status "cancel-requested" after calling updateProcessingInfo in your worker and throw a CancelJobError');
                                }
                                else {
