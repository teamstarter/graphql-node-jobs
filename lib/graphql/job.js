            ...
            after: function (job, oldJob) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    debounceBatch(function () { return __awaiter(_this, void 0, void 0, function () {
                        var batch, jobs, jobsStatus, allJobsAreSuccessful;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, models.batch.findOne({
                                ...
                                case 2:
                                    ...
                                    if (!allJobsAreSuccessful) return [3 /*break*/, 4];
                                ...
                                case 3:
                                    ...
                                    return [3 /*break*/, 6];
                                case 4:
                                    if (!jobsStatus.includes('failed')) return [3 /*break*/, 6];
                                    return [4 /*yield*/, batch.update({
                                            status: 'failed'
                                        })];
                                case 5:
