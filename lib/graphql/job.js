...
function JobConfiguration(graphqlTypes, models, pubSubInstance, onJobFail) {
    ...
    return {
        ...
        update: {
            beforeUpdateFetch: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                    ...
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            if (typeof args.job.processingInfo !== 'string' &&
                                ...
                                typeof ((_c = args.job.processingInfo) === null || _c === void 0 ? void 0 : _c.steps) !== 'undefined' &&
                                ...
                                newSteps = Object.keys(steps_1).reduce(function (acc, stepName) {
                                    ...
                                    var previousStepContent = job.processingInfo && job.processingInfo.steps
                                        ? job.processingInfo.steps[stepName]
                                        : null;
                                    var isStepAlreadySavedAsDone = previousStepContent && previousStepContent.doneAt;
                                    // We set the end date when the status switch to a terminating state.
                                    if (newStepContent.status === 'done' &&
            ...
            afterUpdate: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                var debounceBatch, step, nextStep;
                var _this = this;
                var job = _b.updatedEntity, oldJob = _b.previousPropertiesSnapshot;
        ...
        create: {
            beforeCreate: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                var properties;
                var args = _b.args;
                return __generator(this, function (_c) {
                    properties = args.job;
            ...
            afterCreate: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                var pipeline, indexCount;
                var job = _b.createdEntity, source = _b.source, args = _b.args, context = _b.context, info = _b.info;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
