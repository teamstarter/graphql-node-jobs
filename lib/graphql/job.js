    ...
    return {
        ...
        update: {
            before: function (findOptions, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
                var properties, job, newSteps, steps_1;
                var _a;
                        ...
                        case 1:
                            ...
                            if (typeof args.job.processingInfo !== 'string' &&
                                ...
                                newSteps = Object.keys(steps_1).reduce(function (acc, stepName) {
                                    var newContent = steps_1[stepName];
                                    var isStepAlreadySavedAsDone = job.processingInfo &&
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            ...
                                            case 6:
                                                _a.sent();
                                                return [3 /*break*/, 9];
                                            case 7: return [4 /*yield*/, (0, updatePipelineStatus_1["default"])(batch.pipelineId, models)];
                                            case 8:
                                                _a.sent();
                                                _a.label = 9;
