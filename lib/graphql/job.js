...
function JobConfiguration(graphqlTypes, models, pubSubInstance, onJobFail) {
    ...
    return {
        ...
        update: {
            ...
            afterUpdate: function (_a) {
                var job = _a.updatedEntity, oldJob = _a.previousPropertiesSnapshot;
                return __awaiter(_this, void 0, void 0, function () {
        ...
        create: {
            ...
            afterCreate: function (_a) {
                var job = _a.createdEntity, source = _a.source, args = _a.args, context = _a.context, info = _a.info;
                return __awaiter(_this, void 0, void 0, function () {
