...
exports.workerMonitorUpdate = exports.workerInfoInputType = void 0;
...
var workerMonitorUpdateType = new graphql_1.GraphQLObjectType({
    name: 'workerMonitorUpdate',
    fields: {
        success: { type: graphql_1.GraphQLBoolean }
    }
});
function workerMonitorUpdate(pubSubInstance, models) {
    var _this = this;
    return {
        type: workerMonitorUpdateType,
        description: 'Update workers status',
        args: {
            workers: { type: new graphql_1.GraphQLList(exports.workerInfoInputType) }
        },
        resolve: function (_parent, args) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    ...
                    args.workers.map(function (worker) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, models.workerMonitoring.create({
...
exports.workerMonitorUpdate = workerMonitorUpdate;
