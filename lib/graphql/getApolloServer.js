...
var graphql_sequelize_generator_1 = require("@teamstarter/graphql-sequelize-generator");
...
var workerSuccessRating_1 = require("./workerSuccessRating");
/**
 ...
 */
function getApolloServer(_a) {
    var dbConfig = _a.dbConfig, sequelizeInstance = _a.sequelizeInstance, _b = _a.gsgParams, gsgParams = _b === void 0 ? {} : _b, _c = _a.customMutations, customMutations = _c === void 0 ? {} : _c, onJobFail = _a.onJobFail, _d = _a.wsServer, wsServer = _d === void 0 ? null : _d;
    return __awaiter(this, void 0, void 0, function () {
        var models, types, jobsFail, _i, jobsFail_1, job_2, pubSub, graphqlSchemaDeclaration;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, (0, models_1.getModelsAndInitializeDatabase)({ dbConfig: dbConfig, sequelizeInstance: sequelizeInstance })];
                case 1:
                    models = _e.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, models.sequelize.query("UPDATE job SET status = 'cancelled', output = '{\"error\":\"Cancelled as the job was processing during the server boot.\"}' WHERE status = 'processing';")];
                case 3:
                    _e.sent();
                ...
                case 7:
                    ...
                    graphqlSchemaDeclaration = {
                        ...
                        workerSuccessRating: (0, workerSuccessRating_1.workerSuccessRating)(models)
                    };
