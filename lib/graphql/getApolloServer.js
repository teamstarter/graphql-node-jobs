 ...
 */
function getApolloServer(dbConfig, gsgParams, customMutations, onJobFail) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    models = models_1["default"](dbConfig);
                    types = graphql_sequelize_generator_1.generateModelTypes(models);
                    return [4 /*yield*/, models.job.findAll({
                            where: { status: 'processing' }
                        })];
                case 1:
                    jobsFail = _a.sent();
                    if (!(jobsFail.length > 0)) return [3 /*break*/, 6];
                    return [4 /*yield*/, models.sequelize.query("UPDATE job SET status = 'failed' WHERE status = 'processing'")];
                case 2:
                    _a.sent();
                    if (!onJobFail) return [3 /*break*/, 6];
                    _i = 0, jobsFail_1 = jobsFail;
                    _a.label = 3;
                case 3:
                    if (!(_i < jobsFail_1.length)) return [3 /*break*/, 6];
                    job_2 = jobsFail_1[_i];
                ...
                case 6:
                    graphqlSchemaDeclaration = {
                        job: job_1["default"](types, models, onJobFail),
