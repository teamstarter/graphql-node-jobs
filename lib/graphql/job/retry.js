...
function RetryJob(graphqlTypes, models) {
    ...
    return {
        ...
        resolve: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
            var job, attributesToDelete_1, oldJobAttributes, attributes, newJob;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!(job.status === 'failed')) return [3 /*break*/, 3];
                        attributesToDelete_1 = ['id', 'createdAt', 'updateAt', 'status'];
                        oldJobAttributes = Object.keys(job.dataValues).reduce(function (acc, flag) {
                            if (!attributesToDelete_1.includes(flag)) {
