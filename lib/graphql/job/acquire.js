...
function AcquireJobDefinition(graphqlTypes, models) {
    ...
    return {
        ...
        resolve: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
            var transaction, allJobHoldType, heldTypes, job, workerMonitoring;
            var _a, _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 6:
                        _e.sent();
                        if (!args.workerId) return [3 /*break*/, 11];
                        return [4 /*yield*/, models.workerMonitoring.findOne({
                                where: { workerId: args.workerId },
                                transaction: transaction
                            })];
                    case 7:
                        workerMonitoring = _e.sent();
                        if (!workerMonitoring) return [3 /*break*/, 9];
                    ...
                    case 8:
                        _e.sent();
                        return [3 /*break*/, 11];
                    case 9: return [4 /*yield*/, models.workerMonitoring.create({
                            workerId: args.workerId,
                            lastCalledAt: new Date()
                        }, { transaction: transaction })];
                    case 10:
