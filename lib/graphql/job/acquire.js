    ...
    return {
        ...
        args: {
            ...
            workerVersion: {
                ...
                description: 'Semver version of the code run by the worker. When provided, the jobs whose requiredMinimumVersion is greater than this version are not dispatched to the worker.',
            },
        },
 ...
 */
function getSatisfiedRequiredVersions(models, typeList, workerVersion) {
    return __awaiter(this, void 0, void 0, function () {
        var jobs;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, models.job.findAll({
                        attributes: ['requiredMinimumVersion'],
                        where: {
                            type: typeList,
                            status: 'queued',
                            requiredMinimumVersion: (_a = {}, _a[sequelize_1.Op.ne] = null, _a),
                        },
                ...
                case 1:
                    ...
                    return [2 /*return*/, jobs
                            .map(function (job) { return job.requiredMinimumVersion; })
                            .filter(function (requiredMinimumVersion) {
                            return (0, version_1.isVersionSatisfied)(workerVersion, requiredMinimumVersion);
                        })];
            }
        });
    });
...
function acquireJob(models, args) {
    return __awaiter(this, void 0, void 0, function () {
        var hasWorkerVersion, heldTypes, satisfiedVersions, versionCondition, result, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    hasWorkerVersion = args.workerVersion !== undefined && args.workerVersion !== null;
                    if (hasWorkerVersion && !(0, version_1.isValidVersion)(args.workerVersion)) {
                        throw new Error("The workerVersion must be a valid semver version (like \"1.2.3\"), got \"".concat(args.workerVersion, "\"."));
                    }
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 6, , 7]);
                ...
                case 2:
                    ...
                    satisfiedVersions = [];
                    versionCondition = '';
                    if (!hasWorkerVersion) return [3 /*break*/, 4];
                    return [4 /*yield*/, getSatisfiedRequiredVersions(models, args.typeList, args.workerVersion)];
                case 3:
                    satisfiedVersions = _b.sent();
                    versionCondition =
