        ...
        resolve: function (source, args, context) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (dialect === 'sqlite') {
                    ...
                    return [2 /*return*/, acquireJobSQLite(models, args)];
                }
                else {
                    // Use row-level locking for PostgreSQL and other databases
                    return [2 /*return*/, acquireJobWithRowLocking(models, args)];
                }
                return [2 /*return*/];
            });
        }); }
...
function acquireJobSQLite(models, args) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, allJobHoldType, heldTypes, conditions, job, updatedRows, updatedJob, error_1;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 3:
                    ...
                    if (!heldTypes.includes('all')) return [3 /*break*/, 5];
                ...
                case 7:
                    _e.sent();
                    return [2 /*return*/, null];
                case 8: return [4 /*yield*/, models.job.update({
                ...
                case 9:
                    updatedRows = (_e.sent())[0];
                    if (!(updatedRows === 0)) return [3 /*break*/, 11];
                ...
                case 12:
                    _e.sent();
                    return [4 /*yield*/, models.job.findByPk(job.id)];
                case 13:
                    updatedJob = _e.sent();
...
function acquireJobWithRowLocking(models, args) {
    return __awaiter(this, void 0, void 0, function () {
        var transaction, allJobHoldType, heldTypes, conditions, job, error_2;
        var _a, _b, _c, _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0: return [4 /*yield*/, models.sequelize.transaction({
                ...
                case 7:
                    _e.sent();
                    return [2 /*return*/, null];
                case 8: return [4 /*yield*/, job.update({
                        workerId: args.workerId,
                        status: 'processing',
                        startedAt: new Date()
                    }, { transaction: transaction })];
