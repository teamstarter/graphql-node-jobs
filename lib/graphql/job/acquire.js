...
function getInstanceOfDebounceWorker(workerId) {
    ...
    if (!instance.length) {
        ...
        return allInstanceOfDebounceWorker.filter(function (instance) { return instance.workerId === workerId; })[0].debounce;
    }
                ...
                switch (_e.label) {
                    ...
                    case 6:
                        ...
                        if (args.workerId) {
                            ...
                            debounceWorker(function () { return __awaiter(_this, void 0, void 0, function () {
