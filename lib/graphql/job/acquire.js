            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, models.sequelize.transaction(transactionOptions, function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, getHeldTypes(models, transaction)]; // Pass the transaction here
                                    case 1:
                                        heldTypes = _a.sent() // Pass the transaction here
                                        ;
                                        if (heldTypes.includes('all')) {
                                            return [2 /*return*/, null];
                                        }
...
function attemptJobAcquisition(models, conditions, args, transaction) {
    return __awaiter(this, void 0, void 0, function () {
        var job, updateFields, updateOptions, updatedRows, error_5;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    ...
                    return [4 /*yield*/, models.job.findByPk(job.id, { transaction: transaction })]; // Ensure transaction is passed
                case 3: return [2 /*return*/, _b.sent()]; // Ensure transaction is passed
                case 4:
                    error_5 = _b.sent();
...
function getHeldTypes(models, transaction // Added optional transaction parameter
) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, models.jobHoldType.findAll({ transaction: transaction })]; // Now using the transaction if passed
                case 1:
                    allJobHoldType = _a.sent() // Now using the transaction if passed
                    ;
...
function buildConditions(args, heldTypes) {
    ...
    if (heldTypes.length > 0) {
        console.log('Held types:', heldTypes);
        conditions.push({
