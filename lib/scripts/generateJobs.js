...
function generateJobs(models) {
    return __awaiter(this, void 0, void 0, function () {
        var status, fakeJobs, jobID, startDate, i, currentDate, numberOfJobs, i_1, randomStatus;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, models.job.truncate()
                        // 371 days
                    ];
                case 1:
                    _a.sent();
                    ...
                    for (i = 0; i < 10; i++) {
                        ...
                        numberOfJobs = getRandomInt(0, 10);
                        for (i_1 = 0; i_1 < numberOfJobs; i_1++) {
                            randomStatus = status[getRandomInt(0, 3)];
                            fakeJobs.push({
                                id: jobID,
                                type: 'fakeJob',
                                status: randomStatus,
