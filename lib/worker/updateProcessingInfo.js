...
function updateProcessingInfo(client, job, processingInfo, isCancelledOnCancelRequest) {
    return __awaiter(this, void 0, void 0, function () {
        var newProcessingInfo, steps_1, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    newProcessingInfo = null;
                    if (typeof processingInfo !== 'string' &&
                        typeof processingInfo !== 'number' &&
                        typeof processingInfo !== 'boolean' &&
                        !Array.isArray(processingInfo) &&
                        typeof (processingInfo === null || processingInfo === void 0 ? void 0 : processingInfo.steps) !== 'undefined' &&
                        typeof processingInfo.steps !== null) {
                        steps_1 = processingInfo.steps;
                ...
                case 1:
                    response = _a.sent();
                    if (isCancelledOnCancelRequest &&
                        response.data.job.status === 'cancel-requested') {
                        throw new job_1.CancelRequestedError('A job cancelation was requested !');
                    }
                    else {
