...
// Only used when the worker reports its version, so that the workers that do not
// use this option keep working with servers not knowing the workerVersion argument.
var acquireJobWithVersionQuery = (0, graphql_tag_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  mutation acquireJob(\n    $typeList: [String!]!\n    $workerId: String\n    $workerType: String\n    $workerVersion: String\n  ) {\n    job: acquireJob(\n      typeList: $typeList\n      workerId: $workerId\n      workerType: $workerType\n      workerVersion: $workerVersion\n    ) {\n      id\n      type\n      name\n      input\n      output\n      status\n    }\n  }\n"], ["\n  mutation acquireJob(\n    $typeList: [String!]!\n    $workerId: String\n    $workerType: String\n    $workerVersion: String\n  ) {\n    job: acquireJob(\n      typeList: $typeList\n      workerId: $workerId\n      workerType: $workerType\n      workerVersion: $workerVersion\n    ) {\n      id\n      type\n      name\n      input\n      output\n      status\n    }\n  }\n"])));
function handleJobResult(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var result, err_1;
        var client = _b.client, job = _b.job, output = _b.output, looping = _b.looping, args = _b.args;
...
function handleError(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var updatedErrorJob;
        var err = _b.err, client = _b.client, job = _b.job, looping = _b.looping, args = _b.args;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    debug('Error during the job processing', err);
                    updatedErrorJob = null;
                    if (!(err.name === 'CancelRequestedError')) return [3 /*break*/, 3];
                    return [4 /*yield*/, new Promise(function (resolve) { return setTimeout(resolve, 0); })];
                case 1:
                    _c.sent();
                    return [4 /*yield*/, client.mutate({
...
function checkForJobs(args) {
    return __awaiter(this, void 0, void 0, function () {
        var processingFunction, client, typeList, _a, workerId, workerType, workerVersion, _b, looping, _c, loopTime, _d, isCancelledOnCancelRequest, _e, nonBlocking, data, job, output, processingPromise, err_2;
        var _this = this;
        return __generator(this, function (_f) {
            switch (_f.label) {
                case 0:
                    ...
                    if (args.workerVersion !== undefined &&
                        args.workerVersion !== null &&
                        !(0, version_1.isValidVersion)(args.workerVersion)) {
                        throw new Error("Please provide a valid semver workerVersion (like \"1.2.3\"), got \"".concat(args.workerVersion, "\"."));
                    }
                    if (!args.workerId) {
                        args.workerId = (0, uuid_1.default)();
                    }
                    processingFunction = args.processingFunction, client = args.client, typeList = args.typeList, _a = args.workerId, workerId = _a === void 0 ? undefined : _a, workerType = args.workerType, workerVersion = args.workerVersion, _b = args.looping, looping = _b === void 0 ? true : _b, _c = args.loopTime, loopTime = _c === void 0 ? DEFAULT_LOOP_TIME : _c, _d = args.isCancelledOnCancelRequest, isCancelledOnCancelRequest = _d === void 0 ? false : _d, _e = args.nonBlocking, nonBlocking = _e === void 0 ? false : _e;
                    return [4 /*yield*/, client.mutate(workerVersion
                            ? {
                                mutation: acquireJobWithVersionQuery,
                                variables: { typeList: typeList, workerId: workerId, workerType: workerType, workerVersion: workerVersion },
                            }
                            : {
                ...
                case 2:
                    ...
                    processingPromise = processingFunction(job, {
                        updateProcessingInfo: function (info) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, (0, updateProcessingInfo_1.default)(client, job, info, isCancelledOnCancelRequest)];
                                    case 1:
                                        _a.sent();
                                        return [2 /*return*/];
                                }
