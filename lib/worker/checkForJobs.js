...
function checkForJobs(_a) {
    var processingFunction = _a.processingFunction, client = _a.client, typeList = _a.typeList, _b = _a.workerId, workerId = _b === void 0 ? undefined : _b, _c = _a.looping, looping = _c === void 0 ? true : _c, _d = _a.loopTime, loopTime = _d === void 0 ? 1000 : _d;
                ...
                case 2:
                    ...
                    return [4 /*yield*/, processingFunction(job, {
                            updateProcessingInfo: function (info) {
                                return updateProcessingInfo_1["default"](client, job, info);
                            }
                        })];
                case 3:
                    output = _e.sent();
