...
var jsonSafe_1 = require("./jsonSafe");
...
function handleJobResult(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var safeOutput, size, result, err_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    safeOutput = (0, jsonSafe_1.makeJsonSafe)(output);
                    size = (0, jsonSafe_1.getJsonSizeInBytes)(safeOutput);
                    if (size > 45 * 1024 * 1024) {
                        debug('Warning: job output size is close to the 50mb limit.', { bytes: size });
                    }
                ...
                case 2: return [4 /*yield*/, client.mutate({
                        ...
                        variables: {
                            job: {
                                id: job.id,
                                status: 'failed',
                                output: (0, jsonSafe_1.makeJsonSafe)({
